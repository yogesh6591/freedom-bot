...
const Img = ({ src, alt }: ImgProps) => {
  ...
  // React's img typings widen `src` to `string | Blob`, but next/link and
  // next/image both need a string URL. A Blob src cannot be rendered by either,
  // so treat it as an unavailable image rather than casting and crashing.
